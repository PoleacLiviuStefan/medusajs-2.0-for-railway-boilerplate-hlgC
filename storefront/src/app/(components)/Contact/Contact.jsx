  ...
  return (
    <div name="Contact" className='flex flex-col items-center   w-full h-full flex  py-[5rem] font-montSerrat bg-[#0b2a24] text-white'>
        ...
        <div className='flex  mt-[2rem]'>
            <a href='https://www.instagram.com/lorenalashstudio/' className='flex justify-center items-center  w-[50px] lg:w-[60px] h-[50px] lg:h-[60px] bg-black rounded-[50%] text-[28px] bg-white text-white mx-2'>
                <BsInstagram/>
            </a>
